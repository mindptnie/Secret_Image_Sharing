...
from Shamir import polynomial, decode
...
if __name__ == "__main__":
    ...
    train_data_path = os.path.join(BASE_DIR, "Pic", "Baboon", "Tranning data")
    test_data_path  = os.path.join(BASE_DIR, "Pic", "Baboon", "Testing data")
